...
class formulaire{
    ...
    function erreur($message,$bt_close,$timeout=0){
        ...
        $erreur .= '<div class="alert_message erreur '.$class_timeout.'">';
            $erreur .= '<img src="image/exclamation.png" alt="" title=""/>';
            $erreur .= '<span class="alert_message_content">'.$message.'</span>';
            if($bt_close == 1){
                $erreur .= '<img src="image/bt_close_petite.png" alt="" title="" class="alert_message_button"/>';
            }
    ...
    function valide($message,$bt_close,$timeout=0){
        ...
        $valide .= '<div class="alert_message valide '.$class_timeout.'">';
            $valide .= '<img src="image/information_moyenne.png" alt="" title=""/>';
            $valide .= '<span class="alert_message_content">'.$message.'</span>';
            if($bt_close == 1){
                $valide .= '<img src="image/bt_close_petite.png" alt="" title="" class="alert_message_button"/>';
            }
